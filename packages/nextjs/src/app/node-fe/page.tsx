  ...
  return (
    <div className="container mx-auto mt-20 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mt-6 lg:grid-cols-3 gap-4">
        ...
        <div className="flex justify-center gap-8 mt-10 items-center ">  <Button> Deposit</Button> <Button> Withdraw</Button></div>
        
        </MiddleCard>
        <MiddleCard title="Active messages" bottom=" " >
          <div className=" mt-5 mb-5 font-bold text-center text-3xl text-white"> 11.237 TX </div>
          <div className="flex justify-center gap-8 mt-10 items-center ">  <Button> Look all messages</Button> </div>
        
          
          </MiddleCard>
        <MiddleCard title="Current Price" bottom="" > 
        <div className=" mt-5 mb-5 font-bold text-center text-3xl text-white"> $0.40/hour</div>
        <div className="flex justify-center gap-8 mt-10 items-center ">  <Button> Change price </Button> </div>
